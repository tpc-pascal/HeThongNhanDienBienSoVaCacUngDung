  ...
  const loadProfile = async () => {
    ...
    try {
      ...
      if (staffError) {
        ...
        toast.error('Lỗi tải thông tin giám sát');
        return;
      }
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-200">
          <div className="flex flex-col md:flex-row md:items-center gap-6 mb-8">
            <div className="relative w-28 h-28 md:w-32 md:h-32">
              <div className="w-full h-full rounded-full overflow-hidden bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center">
                {avatarPreview ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
              ...
              {profile?.duocchuyenbai ? (
                <>
                  <div className="text-xl font-bold text-emerald-700 mb-2">✅ Đã được cấp phép</div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-200">
          ...
          <div className="mt-6 flex flex-col md:flex-row gap-3">
            {editing ? (
              <>
                ...
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold hover:shadow-lg transition disabled:opacity-60"
                >
              ...
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold hover:shadow-lg transition"
              >
            ...
            <button
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl border border-green-200 bg-green-50 text-green-700 font-semibold hover:bg-green-100 transition"
            >
        ...
        {profile?.duocchuyenbai && (
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-200">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white py-4 rounded-xl font-bold hover:from-green-700 hover:to-emerald-700 transition shadow-lg flex items-center justify-center gap-3 text-lg"
            >
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8">
            ...
            <div className="flex gap-3 mt-8">
              ...
              <button
                ...
                className="flex-1 bg-gradient-to-r from-green-600 to-emerald-600 text-white py-3 rounded-xl font-bold hover:from-green-700 hover:to-emerald-700 transition shadow-lg flex items-center justify-center gap-2"
              >
